...
import application.helpers.TransactionType.TransactionTypesDBHelper;
...
//		System.out.println("RESET"); // tester
	...
	public void deleteType(String typeName) {
		TransactionTypesDBHelper.removeType(typeName);
