...
public class EnterScheduledTransactionController implements Initializable {
	...
	public void createScheduledTransaction() {
		...
		try {
			...
			if (ScheduledTransactionsDAO.hasDuplicateScheduledTransactionName(scheduledTransactionName)) {
			...
			ScheduledTransactionsDAO.insertScheduledTransaction(scheduledTransactionName, scheduledTransactionAccount,
					scheduledTransactionType, scheduledTransactionFrequency, dueDate, payment);
