...
public class EditTransactionPageController {
	...
	public void setTransaction(Transaction transaction) {
		...
		editTransactionDescriptionField.setText(transaction.getTransactionName());
	...
	public void saveChanges() {
		...
		String prevDescription = transaction.getTransactionName();
		...
		try {
			...
			transaction.setTransactionName(transactionDescription);
			...
			TransactionsDAO.updateTransaction(prevDescription, transactionAccountName, transactionTypeName,
