...
public class EditScheduledTransactionPageController {
	...
	public void setTransaction(ScheduledTransaction scheduledTransaction) {
		...
		editScheduledTransactionNameField.setText(scheduledTransaction.getTransactionName());
	...
	public void saveChanges() {
		String prevName = scheduledTransaction.getTransactionName();
		...
		try {
			...
			scheduledTransaction.setTransactionName(scheduledTransactionName);
...
//			scheduledTransaction.setFrequency()	// already monthly by default
			...
			ScheduledTransactionsDAO.updateScheduledTransaction(prevName, scheduledTransactionName,
