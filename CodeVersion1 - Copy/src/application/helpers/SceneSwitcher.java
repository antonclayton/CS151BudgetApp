...
public class SceneSwitcher {
	...
	public static void goToTransactionsByAccountPage(HBox mainBox) {
		switchScene(mainBox, "/view/TransactionsByAccount.fxml");
	}

	public static void goToTransactionsByTypePage(HBox mainBox) {
		switchScene(mainBox, "/view/TransactionsByType.fxml");
	}
}
